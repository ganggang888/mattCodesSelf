...
$(function () {
    ...
    $("#searchMenuKeyWord").keyup(function () {
        ...
        function () {
            ...
            $("#allmenuslink .menu_item_linkbutton").html("杩斿洖");
            isAllDefault = false;
    ...
    $(".apps_container li").live("click", function () {
        var app = '<li><span class="delete" style="display:inline">脳</span><img src="" class="icon"><a href="#" class="title"></a></li>';
        var $app = $(app);
...
'<a class="macro-component-tabclose" href="javascript:void(0)" title="鐐瑰嚮鍏抽棴鏍囩"><span></span><b class="macro-component-tabclose-icon">脳</b></a>'+
'</li>';
