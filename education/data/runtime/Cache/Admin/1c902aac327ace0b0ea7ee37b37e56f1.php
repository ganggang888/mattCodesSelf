...
<div class="wrap jj">
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:;" target="_self">修改VCR</a></li>
  </ul>
  <div class="common-form">
    <form method="post" class="form-horizontal J_ajaxForm" action="<?php echo U('Vcr/edit_post');?>">
      <fieldset>
        <div class="control-group">
          <label class="control-label">vcr名称:</label>
          <div class="controls">
            <input type="text" class="input" name="name" value="<?php echo ($info["name"]); ?>"><input type="hidden" name="id" value="<?php echo ($info["vid"]); ?>">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            ...
            <select name="type">
              <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["value"]); ?>" <?php if($vo[value] == $info[type]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
            <span class="must_red">*</span> </div>
        </div>
        <div class="control-group">
          ...
          <div class="controls">
            <div  style="text-align: left;"><input type='hidden' name='img' id='thumb' value="<?php echo ($info["img"]); ?>">
			<a href='javascript:void(0);' onClick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
			
			<?php if(empty($info['img'])): ?><img src="/education/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
			<?php else: ?>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            ...
            <span class="must_red">*</span>已上传视频：<?php echo ($info["media"]); ?></div>
        </div>
        <div class="control-group">
          <label class="control-label">介绍:</label>
          <div class="controls">
            <div id='content_tip'></div>
            <script type="text/plain" id="content" name="about"><?php echo ($info["about"]); ?></script> 
            <script type="text/javascript">
                //编辑器路径定义
