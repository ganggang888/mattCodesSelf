...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Teacher/index');?>">所有教师</a></li>
			<li class="active"><a href="javascript:;" target="_self">添加教师</a></li>
		</ul>
		<div class="common-form">
			<form method="post" class="form-horizontal J_ajaxForm" action="<?php echo U('Teacher/add_post');?>">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label">教师背景:</label>
						<div class="controls">
							<textarea name="background" rows="5" cols="57"></textarea>
							<span class="must_red">*</span>
						</div>
					</div>
                    <div class="control-group">
						<label class="control-label">教师图像:</label>
						<div class="controls">
            ...
            <input type="button"  class="btn" onClick="$('#thumb_preview').attr('src','/education/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
					...
					<div class="control-group">
						<label class="control-label">教师荣誉:</label>
						<div class="controls">
							<textarea name="honour" rows="5" cols="57"></textarea>
							<span class="must_red">*</span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="had_do" value="">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">著作:</label>
						<div class="controls">
                    ...
                    <div class="control-group">
						...
						<div class="controls">
                            <textarea name="territory" rows="5" cols="57"></textarea>
						</div>
					</div>
                    <div class="control-group">
						<label class="control-label">专家见解:</label>
						<div class="controls">
							<input type="text" class="input" name="talk" value="">
						</div>
					</div>
				</fieldset>
				<div class="form-actions">
					<button type="submit" class="btn btn-primary btn_submit J_ajax_submit_btn">添加</button>
					<a class="btn" href="/education/index.php/Admin/Teacher">返回</a>
				</div>
			</form>
		</div>
	</div>
