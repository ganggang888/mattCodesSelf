...
<div class="main1">
  ...
  <div class="m_r">
    <div class="m_r1">
      ...
      <div class="m_rz">
        <div class="m_rz1"> <span><font color="#333">首页</font>&nbsp;>&nbsp;VCR欣赏</span>VCR欣赏</div>
        <div class="new2">
          <ul>
            <?php if(is_array($rows)): foreach($rows as $key=>$vo): $m=1; ?>
            <?php if ($m % 2 == 0) { ?>
            <div style="float:right; width:300px; border:solid 1px #CCC; margin-bottom:70px"><a href="<?php echo leuu('Portal/vcr/detail',array('id'=>$vo['vid']));?>" style="width:300px; float:left"><img src="<?php echo ($vo["img"]); ?>" width="300" height="200" /></a><a href="<?php echo leuu('Portal/vcr/detail',array('id'=>$vo['vid']));?>" style=" position:relative; text-align:center; width:300px; float:left; height:30px; line-height:30px"><?php echo ($vo["name"]); ?></a></div>
            <?php }else { ?>
            <div style="float:left; width:300px; border:solid 1px #CCC; margin-bottom:70px"><a href="<?php echo leuu('Portal/vcr/detail',array('id'=>$vo['vid']));?>" style="width:300px; float:left"><img src="<?php echo ($vo["img"]); ?>" width="300" height="200" /></a><a href="<?php echo leuu('Portal/vcr/detail',array('id'=>$vo['vid']));?>" style=" position:relative; text-align:center; width:300px; float:left; height:30px; line-height:30px"><?php echo ($vo["name"]); ?></a></div>
            <?php } ?>
