...
<div class="banner1"><img src="/tpl/simplebootx/Public/images/banner1.jpg" width="1002" height="246" /></div>
<div class="main1">
  <div class="m_l">
    <div class="m_lt"><img src="/tpl/simplebootx/Public/images/left_t.jpg" width="213" height="32" /></div>
    <div class="m_lz">
    ...
    <!--<div class="tu1"><a href="about.html?id=37"><img src="/tpl/simplebootx/Public/images/tu1.jpg" width="213" height="142" border="0" /></a></div>-->
  </div>
  <div class="m_r">
    <div class="m_r1">
      <div class="m_rt"><img src="/tpl/simplebootx/Public/images/right_t.jpg" width="771" height="38" /></div>
      <div class="m_rz">
        <div class="m_rz1"> <span><font color="#333">首页</font>&nbsp;>&nbsp;教师介绍</span>教师介绍</div>
        
        <?php if(is_array($rows)): foreach($rows as $key=>$vo): ?><div class="m_rz2">
          <div class="m_rz3"><a href="<?php echo leuu('Portal/teacher/detail',array('id'=>$vo['id']));?>"><img src="<?php echo ($vo["img"]); ?>" width="152" height="184" border="0" /></a></div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>姓名：</span>
              <input type="text" class="bd" value="<?php echo ($vo["name"]); ?>" />
            </div>
          </div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>教师背景：</span>
              <input type="text" class="bd" value="<?php echo ($vo["background"]); ?>" />
            </div>
          </div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>荣誉：</span>
              <input type="text" class="bd" value="<?php echo ($vo["honour"]); ?>" />
            </div>
          </div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>曾经任职：</span>
              <input type="text" class="bd" value="<?php echo ($vo["had_do"]); ?>" />
            </div>
          </div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>著作：</span>
              <input type="text" class="bd" value="<?php echo ($vo["book"]); ?>" />
            </div>
          </div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>专业领域：</span>
              <input type="text" class="bd" value="<?php echo ($vo["territory"]); ?>" />
            </div>
          </div>
          <div class="m_rz4">
            <div class="m_rz5"> <span>专家见解：</span>
              <input type="text" class="bd" value="<?php echo ($vo["talk"]); ?>" />
            </div>
          </div>
      ...
      <div class="m_rb"> <img src="/tpl/simplebootx/Public/images/right_b.jpg" width="771" height="38" /></div>
    </div>
  </div>
</div>
  <div class="clear"></div>
