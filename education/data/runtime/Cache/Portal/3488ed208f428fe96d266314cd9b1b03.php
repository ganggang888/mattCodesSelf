...
<div class="main1">
  ...
  <div class="m_r">
    <div class="m_r1">
      ...
      <div class="m_rz">
        <div class="m_rz1"> <span><font color="#333">首页</font>&nbsp;>&nbsp;<?php echo ($name); ?></span><?php echo ($name); ?></div>
        <?php $lists = sp_sql_posts_paged("cid:$cat_id;order:post_date DESC;",10); ?>
        <div class="new2">
          <ul>
            <?php if(is_array($lists['posts'])): $i = 0; $__LIST__ = $lists['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><?php echo ($vo["post_date"]); ?></span><a href="<?php echo leuu('Portal/article/index',array('id'=>$vo['tid']));?>"><?php echo ($vo["post_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
        <div class="shu2">
          <div class="ppage"><?php echo ($lists['page']); ?></div>
        </div>
      </div>
