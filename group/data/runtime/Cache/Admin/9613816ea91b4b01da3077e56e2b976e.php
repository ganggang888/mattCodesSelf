...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Pregnancy/index');?>">孕期列表</a></li>
			<li class="active"><a href="javascript:;">修改第<?php echo ($info["week"]); ?>周孕期信息</a></li>
		</ul>
		<div class="common-form">
			<form method="post" class="form-horizontal J_ajaxForm" action="">
				<fieldset>
					<div class="control-group">
						<label class="control-label">宝宝身高:</label>
						<div class="controls">
							<input type="text" class="input" name="height" value="<?php echo ($info["height"]); ?>">
							<span class="must_red">*</span>
					  </div>
				  </div>
					<div class="control-group">
						<label class="control-label">宝宝体重:</label>
						<div class="controls">
							<input type="text" class="input" name="weight" value="<?php echo ($info["weight"]); ?>">
							<span class="must_red">*</span>
					  </div>
				  </div>
                    <div class="control-group">
						<label class="control-label">本周信息:</label>
						<div class="controls">
							<textarea rows="6" name="baby_message"><?php echo ($info["baby_message"]); ?></textarea>
							<span class="must_red">*</span>
					  </div>
				  </div>
                    
                    <div class="control-group">
						<label class="control-label">准妈妈变化:</label>
						<div class="controls">
							<textarea rows="6" name="mother_info"><?php echo ($info["mother_info"]); ?></textarea>
							<span class="must_red">*</span>
					  </div>
				  </div>
                    
                    <div class="control-group">
						<label class="control-label">每日任务:</label>
						<div class="controls">
							<textarea rows="6" style="height:200px" name="taskall"><?php echo ($info["taskall"]); ?></textarea>
							<span class="must_red">*</span>
					  </div>
				  </div>
				...
				<div class="form-actions">
					...
					<a class="btn" href="/group/index.php/Admin/Pregnancy">返回</a>
				</div>
			</form>
		</div>
	</div>
...
<style>
textarea{ width:40%!important; height:}
</style>
</body>
</html>