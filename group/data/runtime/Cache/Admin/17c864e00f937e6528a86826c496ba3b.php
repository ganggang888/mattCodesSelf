...
<html>
	<head>
		...
		<link href="/group/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/group">ThinkCMF <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/group/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
<script src="/group/public/js/wind.js"></script>
<script src="/group/public/js/jquery.js"></script>
<script type="text/javascript" src="/group/public/js/common.js"></script>
<script>
;(function(){
