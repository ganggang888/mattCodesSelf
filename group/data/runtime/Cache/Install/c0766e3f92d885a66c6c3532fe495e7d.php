...
<link rel="stylesheet" href="/group/public/simpleboot/themes/flat/theme.min.css" />
<link rel="stylesheet" href="/group/public/install/css/install.css" />
<link rel="stylesheet" href="/group/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css" />
...
<body>
	...
	<div class="version"><?php echo (SIMPLEWIND_CMF_VERSION); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="/group/index.php?g=install&a=step4" method="post">
				...
				<div class="bottom text-center">
					<a href="/group/index.php?g=install&a=step2" class="btn btn-primary">上一步</a>
					<button type="submit" class="btn btn-primary">创建数据</button>
				</div>
			</form>
		</section>
		<script src="/group/public/js/jquery.js"></script>
		<script src="/group/public/js/validate.js"></script>
		<script src="/group/public/js/ajaxForm.js"></script>
		<script>
			function TestDbPwd() {
				...
				var url = "/group/index.php?g=install&a=testdbpwd";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
