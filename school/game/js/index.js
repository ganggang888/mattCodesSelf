...
var Main = {
	...
	over : function(){
		...
		if(this.level >= 100){
			...
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "你牛B呀,下了<label>"+this.level+"</label>层,你是个好宝宝！";
			...
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "你太菜了,才玩了<label>"+this.level+"</label>层,你是个弱智的宝宝！";
