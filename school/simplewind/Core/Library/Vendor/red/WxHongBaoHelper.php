...
class WxHongBaoHelper
{
	...
	public function get_sign(){
		define('PARTNERKEY',"01c6d59a3f9024db6336662acg5c8e74");
		try {
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT,'../wchat/lib/apiclient_cert.pem');
 		curl_setopt($ch,CURLOPT_SSLKEY,'../wchat/lib/apiclient_key.pem');
 		curl_setopt($ch,CURLOPT_CAINFO,'../wchat/lib/rootca.pem');
