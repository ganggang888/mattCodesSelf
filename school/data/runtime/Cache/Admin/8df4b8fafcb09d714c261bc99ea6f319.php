...
<?php $row = getClassInfo(); var_dump($row); ?>
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Info/index');?>">课程信息</a></li>
			<li class="active"><a href="javascript:;">添加信息</a></li>
		</ul>
		<div class="common-form">
			<form method="post" class="form-horizontal J_ajaxForm" action="<?php echo U('Info/add_post');?>">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
                            ...
                            <input type="hidden" class="input" name="add_time" value="<?php echo date('Y-m-d H:i:s');?>">
							<span class="must_red">*</span>
						</div>
					</div>
