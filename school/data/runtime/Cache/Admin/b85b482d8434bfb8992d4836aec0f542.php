...
<div class="wrap J_check_wrap">
    ...
    <form method="post" class="form-horizontal J_ajaxForms" action="<?php echo U('Sdtmain/result_general_post',array('student_id'=>$student['id'],'info_id'=>$class['id']));?>">
        <fieldset>
            <div class="control-group">
                <label class="control-label">获证时间:</label>
                <div class="controls">
                <input type="text" name="post[pass_time]" id="pass_time"  value="<?php echo date('Y-m-d',time());?>" size="21" class="J_date" >
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">课程评价:</label>
                <div class="controls">
                <textarea name='post[general_result]' id='general_result' style='width:60%;height:100px;'></textarea>
                </div>
            </div>
        </fieldset>
