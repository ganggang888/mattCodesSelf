...
<?php $now_term = sp_get_term($term_id); $pid = $now_term['parent']; if($pid != 0){ $p_term = sp_get_term($pid); $grand_id = $p_term['parent']; if($grand_id != 0){ $grand = sp_get_term($grand_id); } } ?>
	...
	<div class="bread">
		...
		<div class="fr">
			<a href="<?php echo ($Tink["const"]["WEB_PATH"]); ?>">首页</a>><a href="<?php echo leuu('portal/index/page',array('id'=>22));?>">技术验方</a>><a><?php echo ($name); ?></a>
		</div>
	</div>
	<!--面包结束-->
	...
	<div class="main clearfix">
		<div class="left">
                <?php if(is_array($result)): foreach($result as $key=>$vo): $smeta=json_decode($vo['smeta'], true); ?>
                <dl>
		...
		<div class="right">
        <link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/bootstrap.css" /><link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/common.css" />
<link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/bootstrap-extends.css" />

    <link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/web.css" />
<link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/graceful.css" />
<link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/member.css" />
    <link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/hack.css" />
    <link rel="stylesheet" media="screen" href="http://ys.qhyst.org/Public/Index/css/phone.css" />
...
<div class="ticket-calendar-bounding-box" id="calendar-760" style="position: relative; width: 330px;">
<div class="calendar-container">
<div class="content-box">
<div class="date-box">
<div class="inner" style="width: 330px;">
<table>
<thead>
<tr>
    <th class="weekend">
...
<?php var_dump($_GET['name']); $todo = getData(0,$info,$_GET['name']); ?>
<tbody>
<?php echo ($todo["html"]); ?>
</tbody>
</table>
