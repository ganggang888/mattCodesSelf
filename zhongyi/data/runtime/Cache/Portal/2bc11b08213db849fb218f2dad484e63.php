...
<head>
    ...
    <link href="/zhongyi/statics/js/artDialog/skins/default.css" rel="stylesheet" />
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
			...
			<img src='/zhongyi/statics/images/icon/upload-pic.png' id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
			<!-- <input type="button" class="btn" onclick="crop_cut_thumb($('#thumb').val());return false;" value="裁减图片">  -->
            <input type="button"  class="btn" onClick="$('#thumb_preview').attr('src','/zhongyi/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
            </div>
			</td>
        </tr>
        <tr>
    ...
    <div class="table_full">
      <table class="table table-bordered">
            <tr>
              <th width="80">栏目</th>
              <td>
				<select multiple="multiple" style="height: 300px;" name="term[]">
					<?php echo ($taxonomys); ?>
				</select>
				<div>
            ...
            <tr>
              <th width="80">门诊时间</th>
              <td><input type="text" name="post[start]" id="updatetime" value="" size="21" class="input length_3" style="width: 160px;">-<input type="text" name="post[close]" id="updatetime" value="" size="21" class="input length_3 " style="width: 160px;"><span class="must_red">仅在传承人栏目有效</span></td>
            </tr>
            <tr>
              <th width="80">标签</th>
              <td>
              ...
              <?php if(is_array($tag)): foreach($tag as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
            ...
            <tr>
              ...
              <script type="text/plain" id="content" name="post[post_content]"></script>
                ...
                <script type="text/javascript"  src="/zhongyi/statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="/zhongyi/statics/js/ueditor/ueditor.all.min.js"></script>
				</td>
            </tr>
...
<script type="text/javascript" src="/zhongyi/statics/js/content_addtop.js"></script>
<script type="text/javascript"> 
$(function () {
