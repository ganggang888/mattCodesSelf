  ...
  <div class="col-auto">
    <div class="table_full">
      <table class="table table-bordered">
            ...
            <tr>
              <th width="80">门诊时间</th>
              <td><input type="text" name="post[start]" id="updatetime" value="<?php echo ($post['start']); ?>" size="21" class="input length_3" style="width: 160px;">-<input type="text" name="post[close]" id="updatetime" value="<?php echo ($post['close']); ?>" size="21" class="input length_3 " style="width: 160px;"><span class="must_red">仅在传承人栏目有效</span></td>
            </tr>
            <tr>
              <th width="80">标签</th>
              <td>
              ...
              <?php if(is_array($tag)): foreach($tag as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $post['tag']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
