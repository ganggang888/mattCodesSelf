...
<?php $now_term = sp_get_term($term_id); $pid = $now_term['parent']; if($pid != 0){ $p_term = sp_get_term($pid); $grand_id = $p_term['parent']; if($grand_id != 0){ $grand = sp_get_term($grand_id); } } ?>
	...
	<div class="main clearfix">
		<div class="left">
			...
			<div class="userpic table">
				<div class="cell">
					<?php if(!empty($imgs['thumb'])): ?><img src="<?php echo sp_get_asset_upload_path($imgs['thumb']);?>" alt="<?php echo ($post_title); ?>">
                    <?php else: ?>
                    <img src="/zhongyi/tpl/simplebootx/Public/img/user.jpeg" alt="<?php echo ($post_title); ?>"><?php endif; ?>
                    <?php if($term_id == 7): ?><span class="red"><i><?php echo ($post_title); ?></i><br><span>门诊时间：<?php echo ($start); ?>-<?php echo ($close); ?></span></span>
                    <?php else: ?>
                    <span class="red"><i><?php echo ($post_title); ?></i><br><span>发布时间：<?php echo ($post_modified); ?></span></span><?php endif; ?>
