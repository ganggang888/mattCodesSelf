	...
	<div class="main clearfix">
		<div class="left">
			<div class="photos clearfix">
				<ul>
                <?php if(is_array($result)): foreach($result as $key=>$vo): $smeta=json_decode($vo['smeta'], true); $last = ($key+1) % 3; ?>
                <li <?php if($last == 0): ?>class="no-pd"<?php endif; ?>>
						<div class="pic">
							<a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>"><img src="<?php echo sp_get_asset_upload_path($smeta['thumb']);?>" width="262" height="184" alt="<?php echo ($vo["post_title"]); ?>"></a>
						</div>
						<div class="red16">
