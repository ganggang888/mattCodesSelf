    ...
    function a(o, m) {
        ...
        b.extend(r, {
            ...
            seekTo: function(s, w, t) {
                ...
                f.add(g).toggleClass(m.disabledClass, s ===
                    0);
                h.add(n).toggleClass(m.disabledClass, s >=
                    r.getSize() - m.size);
                return r
            },
            move: function(u, t, s) {
        ...
        r.onReload(function() {
            ...
            if (m.keyboard) {
                b(document).unbind(q).bind(q, function(t) {
                    ...
                    if (m.keyboard != "static" && c !=
                        r) {
                        return
                    }
                    var u = m.keyboardSteps;
                    if (d && (t.keyCode == 37 || t.keyCode ==
                        39)) {
                        r.move(t.keyCode == 37 ? -u : u);
                        return t.preventDefault()
                    }
                    if (!d && (t.keyCode == 38 || t.keyCode ==
                        40)) {
