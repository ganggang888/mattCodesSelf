...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="/Admin/Menu/index">后台菜单</a></li>
			<li class="active"><a href="/Admin/Menu/add/0">添加菜单</a></li>
		</ul>
		<div class="common-form">
			<form method="post" class="form-horizontal J_ajaxForm" action="/Admin/Menu/addPost">
				<fieldset>
