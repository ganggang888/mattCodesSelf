...
{
?>
<frame name="mainFrame" style="zoom:1.0001"   src="main.php?type=psbc" scrolling="AUTO" marginwidth="0" marginheight="0" noresize>      
</frameset>
<?php
} elseif ($_GET['type'] == 'acbc') {
?>
<frame name="mainFrame" style="zoom:1.0001"   src="main.php?type=acbc" scrolling="AUTO" marginwidth="0" marginheight="0" noresize>      
</frameset>
<?php
} elseif ($_GET['type'] == 'bbc')
{
?>
<frame name="mainFrame" style="zoom:1.0001"   src="main.php?type=bbc" scrolling="AUTO" marginwidth="0" marginheight="0" noresize>      
</frameset>
<?php
}
?>
