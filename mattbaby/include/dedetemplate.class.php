        ...
        if (!defined('DEDEDISFUN')) {
            ...
            foreach ($tokens as $token)
            {
                if (is_array($token))
                {
                    ...
                    {
                       $errmsg = 'Qystar Error:function disabled "'.$token[1].'" <a href="http://help.dedecms.com/install-use/apply/2013/0711/2324.html" target="_blank">more...</a>';
                       return FALSE;
                    }
                }
            }
