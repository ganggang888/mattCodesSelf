    ...
    else if($typeid == 999)
	{
		...
		if(!is_array($row))
		{
			...
			if(!empty($linkInfo)){
				...
				$revalue=<<<EOT
<li><a href='http://ad.dedecms.com' target='_blank' title='Qystar广告'>Qystar广告</a></li><li><a href='http://service.dedecms.com' target='_blank' title='织梦客户服务中心'>
...
站长工具</a></li><li><a href='http://site.desdev.cn' target='_blank' title='Qystar建站中心'>
Qystar建站中心</a></li><li><a href='http://help.dedecms.com' target='_blank' title='织梦CMS帮助中心'>
