...
(function(){ 'use strict';
  ...
  StatePlay.prototype.keydown = function( e ) {
	...
	//document.write(_this);
	//writeObj(StatePlay.prototype);
  ...
  StatePlay.prototype.bindEvents = function() {
	...
	Hammer($(".stage")).on("swipedown", function(event) {
            StatePlay.prototype.downOn();
  });
  Hammer($(".stage")).on("swipeup", function(event) {
            StatePlay.prototype.upOn();
  });
  Hammer($(".stage")).on("swipeleft", function(event) {
            StatePlay.prototype.leftOn();
  });
  Hammer($(".stage")).on("swiperight", function(event) {
            StatePlay.prototype.rightOn();
  });
...
$(function(){
  	...
  	$(".up").click(function(){
	  StatePlay.prototype.upOff();
	  StatePlay.prototype.leftOff();
	  StatePlay.prototype.rightOff();
	  StatePlay.prototype.downOff();
	  StatePlay.prototype.upOn();
  	});
	$(".left").click(function(){
	  StatePlay.prototype.leftOn();
